...
public class CircleButton extends ImageView {
	...
	protected void onDraw(Canvas canvas) {
		...
		Log.e("onDraw", "out:"+outerRadius+" preRR"+pressedRingRadius);
	...
	public void set_pressed_ring_width(int dp) {
		...
		this.pressedRingWidth = (int) TypedValue.applyDimension(
				TypedValue.COMPLEX_UNIT_DIP, dp, context.getResources()
						.getDisplayMetrics());
		Log.e("setPRWTest", "Width:"+pressedRingWidth+" out:"+outerRadius);
		this.invalidate();
	}
	...
	private void init(Context context, AttributeSet attrs) {
		...
		Log.e("initTest", "Width:"+pressedRingWidth);
		...
		if (attrs != null) {
			...
			pressedRingWidth = (int) a.getDimension(
					...
					pressedRingWidth);
			Log.e("attrsTest", "Width:"+pressedRingWidth);
	...
	private void showPressedRing() {
		Log.e("showPRTest", "Width:"+pressedRingWidth+" out:"+outerRadius);
